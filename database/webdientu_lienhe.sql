...
CREATE TABLE `lienhe` (
  ...
  `noidung` text,
  `ngaylienhe` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `lienhe` VALUES (2,'Phạm Việt Long','phamvietlong.pass@gmail.com','0368090208','Vĩnh Phúc','Liên hệ','2021-06-19 09:54:01');
